  ...
  $faq =[
    ...
    [
      ...
      <div>
        ...
        <ol class="mb-3">
          <li class="mb-3">
            ...
            <ol type="a" class="my-3">
              <li class="mb-3">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
              <li class="mb-3">Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li>
            </ol>
          </li>
          <li>
        ...
        <p class="mb-5">Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.</p>
  
        <h5 class="mb-4">Stabilire il paese associato al tuo account</h5>
...
<body>
    ...
    <header class="px-4 d-flex justify-content-center flex-column">
      ...
      <div class="d-flex align-items-center mt-3 mb-1">
        ...
        <span class="ms-2 mb-1">Privacy e termini</span>
      </div>
      <ul class="d-flex ps-0 mb-2">
